    ...
    while ~button(joy,13);  end
     ...
     ordem=randperm(10);
          ...
          if ordem(imagemNoGo)== 1 || ordem(imagemNoGo)==2 || ordem(imagemNoGo)==3 % imagens de tubarão
            ...
            answer1{blocos+1,imagemNoGo}='none';
            trava=0;
            while GetSecs<startTime+2
                if (button(joy,13) && trava==0)
                    answer1{blocos+1,imagemNoGo}='space';
    ...
    WaitSecs(5); 
        ...
        while blocos<=5
          ...
          for imagemGo=1:7
            ...
            answer{blocos,imagemGo}='none';
            trava=0;
            while GetSecs<startTime+2
                if (button(joy,13) && trava==0)
                    answer{blocos,imagemGo}='space';
...
rept = rept+1;
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
          ...
          if ordem(imagemNoGo)== 1 || ordem(imagemNoGo)==2 || ordem(imagemNoGo)==3 % imagens de tubarão
            ...
            answer{blocos+1,imagemNoGo}='none';
            trava=0;
            while GetSecs<startTime+2
                if (button(joy,13) && trava==0)
                    answer{blocos+1,imagemNoGo}='space';
